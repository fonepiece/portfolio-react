            ...
            <div className="about-container">
                <div id="about-me">
                    <div className="about-button-container">
                        <span>shortest</span>
                        <button onClick={() => onSelect(1)}></button>
                        <button onClick={() => onSelect(2)}></button>
                        <button onClick={() => onSelect(3)}></button>
                        <button onClick={() => onSelect(4)}></button>
                        <button onClick={() => onSelect(5)}></button>
                        <span>longest</span>
                    </div>
                    {level >= 1 && <p>
                    ...
                    {level >= 5 && <p>Outside Of the Work;<br/>
